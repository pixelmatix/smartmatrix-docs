...
The Schematic, Board Layout, Gerber Files, and BOM can be found in the [SmartMatrix Github Repo](https://github.com/pixelmatix/SmartMatrix/tree/master/hardware) (files start with "SmartMatrixShield_V1").
